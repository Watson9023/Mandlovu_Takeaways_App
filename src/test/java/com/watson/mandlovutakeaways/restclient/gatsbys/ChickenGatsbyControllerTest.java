...
public class ChickenGatsbyControllerTest {
    ...
    public void createColdDrink() throws Exception {
        ...
        ChickenGatsby milkshakes = ChickenGatsbyFactory.getChickenGatsby("Coke", "10");
        URI uri = restTemplate.postForLocation(BASE_URL +"/ChickenGatsby/",milkshakes,ChickenGatsby.class);
    }

    @Test
    public void readColdDrinkByID() throws Exception {
        RestTemplate restTemplate = new RestTemplate();
        ChickenGatsby beverages = restTemplate.getForObject(BASE_URL + "/ChickenGatsby/1",ChickenGatsby.class);
    ...
    public void findAllColdDrinks() throws Exception {
        RestTemplate restTemplate = new RestTemplate();
        List<LinkedHashMap<String,Object>> coldBeverages = restTemplate.getForObject(BASE_URL + "/ChickenGatsbys/",List.class);
    ...
    public void updateColdDrink() throws Exception {
        RestTemplate restTemplate = new RestTemplate();
        ChickenGatsby beverage = ChickenGatsbyFactory.getChickenGatsby("Cokde","10");
        restTemplate.put(BASE_URL + "/ChickenGatsby/1",beverage);
